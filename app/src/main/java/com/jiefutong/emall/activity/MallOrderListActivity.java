...
import com.jiefutong.emall.fragment.MallOrderFragment;
...
public class MallOrderListActivity extends BaseActivity implements View.OnClickListener {
    ...
    class CusAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (fragment == null) {
                fragment = new MallOrderFragment(position);
