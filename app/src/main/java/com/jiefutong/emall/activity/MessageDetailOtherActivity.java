...
public class MessageDetailOtherActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        adapter = new MessageDetailAdapter(R.layout.item_msg_detail_other, datas);
